...
<body>
    ...
    <div class="principal">
		...
		<div class="consulta">
			...
			<div class="menu_adm">
				<a href="adm_cad_lojas.php"><img src="imagens/56-512.png" class="imgadm"/></a>
					<div class="titulo">
						<a href="adm_cad_lojas.php">Cadastrar Nova Loja</a>
					</div>
			</div>
			<div class="menu_adm">
				<a href="adm_all_lojas.php"><img src="imagens/rhyeathaerhte.png" class="imgadm"/></a>
					<div class="titulo">
						<a href="adm_all_lojas.php">Todas as Lojas</a>
					</div>
			</div>
		</div>
    </div>
