...
mysql_select_db("dblivraria");
	...
	$modo=$_GET["modo"];
		if ($modo=="excluir"){
			$cod = $_GET["codcat"];
			$sql="delete from tblcategoria where codcat=".$cod;
		...
		<div class="consulta">
			...
			<tr height="30px" bgcolor="<?php if($linha % 2){ echo "#D8DFFA"; } else { echo "#FFFFFF"; } ?>">
				...
				<td width="200" align="center">
					<a href="adm_cad_categoria.php?modo=editar&codcat=<?php echo($rs["codcat"]) ?>"> Editar </a> | <a href="adm_all_categoria.php?modo=excluir&codcat=<?php echo($rs["codcat"]) ?>">Excluir</a>
				</td>
			</tr>
			<?php
					$linha++;
