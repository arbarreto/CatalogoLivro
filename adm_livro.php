...
<body>
    ...
    <div class="principal">
		...
		<div class="consulta">
			...
			<div class="menu_adm">
				<a href="adm_cad_livro.php"><img src="imagens/add-book-more-plus-choice-128.png" class="imgadm"/></a>
					<div class="titulo">
						<a href="adm_all_livro.php">Cadastrar Livro</a>
					</div>
			</div>
			<div class="menu_adm">
				<a href="adm_all_livro.php"><img src="imagens/19-512.png" class="imgadm"/></a>
					<div class="titulo">
						<a href="adm_all_livro.php">Todos Livros</a>
					</div>
			</div>
		</div>
    </div>
