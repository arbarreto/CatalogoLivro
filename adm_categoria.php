...
<body>
    ...
    <div class="principal">
		...
		<div class="consulta">
			...
			<div class="menu_adm">
				<a href="adm_cad_categoria.php"><img src="imagens/092024-glossy-black-icon-signs-first-aid.png" class="imgadm"/></a>
					<div class="titulo">
						<a href="adm_cad_categoria.php">Cadastrar Nova</a>
					</div>
			</div>
			<div class="menu_adm">
				<a href="adm_all_categoria.php"><img src="imagens/1461621750_icon-40-clipboard-list.png" class="imgadm"/></a>
					<div class="titulo">
						<a href="adm_all_categoria.php">Todas Categorias</a>
					</div>
			</div>
		</div>
    </div>
