...
<body>
    ...
    <div class="principal">
		...
		<div class="consulta">
			...
			<div class="menu_adm">
				<a href="adm_cad_sobre.php"><img src="imagens/1_1-512.png" class="imgadm"/></a>
					<div class="titulo">
						<a href="adm_cad_sobre.php">Cadastrar</a>
					</div>
			</div>
			<?php
			...
			?>
			<div class="menu_adm">
				<a href="adm_cad_sobre.php?modo=editar&codsobre=<?php echo($rs["codsobre"]) ?>"><img src="imagens/write-copy-14138051958gn4k.png" class="imgadm"/></a>
					<div class="titulo">
						<a href="adm_cad_sobre.php?modo=editar&codsobre=<?php echo($rs["codsobre"]) ?>">Editar</a>
					</div>
			</div>
			<?php
				}
