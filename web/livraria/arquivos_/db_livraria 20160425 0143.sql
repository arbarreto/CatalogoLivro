...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ db_livraria;
USE db_livraria;

--
-- Table structure for table `db_livraria`.`contato`
--
...
--
-- Dumping data for table `db_livraria`.`contato`
--
...
--
-- Table structure for table `db_livraria`.`funcao`
--
...
--
-- Dumping data for table `db_livraria`.`funcao`
--
...
--
-- Table structure for table `db_livraria`.`usuario`
--
...
--
-- Dumping data for table `db_livraria`.`usuario`
--
