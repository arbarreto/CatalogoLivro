...
<body>
    ...
    <div class="principal">
		...
		<div class="consulta">
			<div>
				<a href="adm_conteudo.php"><img src="imagens/a-vector-illustration-of-a-wooden-sign-455498.jpg" class="img_voltar"/></a>
			</div>
			<div class="menu_promo">
				<a href="adm_cad_promo.php"><img src="imagens/add-property-xxl.png" class="imgadm"/></a>
					<div class="titulo">
						<a href="adm_cad_promo.php">Cadastrar Promoção</a>
					</div>
			</div>
			<div class="menu_promo">
				<a href="adm_insert_promo.php"><img src="imagens/Folder_Enter-512.png" class="imgadm"/></a>
					<div class="titulo">
						<a href="adm_insert_promo.php">Inserir Livros</a>
					</div>
			</div>
			<div class="menu_promo">
				<a href="adm_all_promo.php"><img src="imagens/select_all-128.png" class="imgadm"/></a>
					<div class="titulo">
						<a href="adm_all_promo.php">Ativar Promoção</a>
					</div>
			</div>
		</div>
    </div>
