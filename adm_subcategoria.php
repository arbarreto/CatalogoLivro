...
<body>
    ...
    <div class="principal">
		...
		<div class="consulta">
			<div>
				<a href="adm_produto.php"><img src="imagens/a-vector-illustration-of-a-wooden-sign-455498.jpg" class="img_voltar"/></a>
			</div>
			<div class="menu_adm">
				<a href="adm_cad_subcategoria.php"><img src="imagens/092024-glossy-black-icon-signs-first-aid.png" class="imgadm"/></a>
					<div class="titulo">
						<a href="adm_cad_subcategoria.php">Cadastrar Nova</a>
					</div>
			</div>
			<div class="menu_adm">
				<a href="adm_all_subcategoria.php"><img src="imagens/1461621750_icon-40-clipboard-list.png" class="imgadm"/></a>
					<div class="titulo">
						<a href="adm_all_subcategoria.php">Todas Subcategorias</a>
					</div>
			</div>
		</div>
    </div>
