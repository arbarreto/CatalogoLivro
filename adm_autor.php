...
<body>
    ...
    <div class="principal">
		...
		<div class="consulta">
			...
			<div class="menu_adm">
				<a href="adm_cad_autor.php"><img src="imagens/Register-512.png" class="imgadm"/></a>
					<div class="titulo">
						<a href="adm_cad_autor.php">Cadastrar Novo</a>
					</div>
			</div>
			<div class="menu_adm">
				<a href="adm_all_autor.php"><img src="imagens/select_all-128.png" class="imgadm"/></a>
					<div class="titulo">
						<a href="adm_all_autor.php">Autor do Mês</a>
					</div>
			</div>
		</div>
    </div>
